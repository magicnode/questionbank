/*
 * Module description: point 知识点与
 */
import mongoose from 'mongoose';

const Schema = mongoose.Schema;

const pointtopicSchema = new Schema({
    point_id: {
...
export default mongoose.model('pointtopic', pointtopicSchema, 'pointtopic');
